...
var data = [{name: "俄罗斯", confirm: 1099, heal: 1213, dead: 23245}]
...
$(function () {
    ...
    //                     },
    //                     pieces: [
    //                         {min: 0, max: 50, color:COLORS[1]},
    //                         {min: 5, max: 100, color:COLORS[2]},
    //                         {min: 100, max: 200, color:COLORS[3]},
    //                         {min: 200, max: 400, color:COLORS[4]},
    //                         {min: 400, max: 800, color:COLORS[5]},
    //                         {min: 800, color:COLORS[6]}
    //                     ],
    //                     inRange: {
    //                         color:COLORS //取值范围的颜色
    //                     }
